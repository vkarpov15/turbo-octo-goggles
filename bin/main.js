...
/***/ function(module, exports, __webpack_require__) {
	...
	var superagent = __webpack_require__(224)(__webpack_require__(225), global.Promise);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var middleware = __webpack_require__(247);
	var reducer = __webpack_require__(248);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LoggedOutView = function LoggedOutView(props) {
	...
	var LoggedInView = function LoggedInView(props) {
	  if (props.state.currentUser) {
	    return React.createElement(
	      'ul',
	      { className: 'nav navbar-nav pull-xs-right' },
	    ...
	    value: function render() {
	      return React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(LoggedInView, { state: this.props.state })
	        )
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Login = function (_React$Component) {
	  ...
	  function Login() {
	    ...
	    _this.changePassword = function (ev) {
	      return store.dispatch({
	        type: 'UPDATE_FIELD',
	        key: 'password',
	        value: ev.target.value
	    ...
	    _this.submitForm = function (ev) {
	      ...
	      store.dispatch({
	        type: 'LOGIN',
	        payload: agent.Auth.login(_this.state.email, _this.state.password)
	      });
	    };
	    return _this;
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Register = function (_React$Component) {
	  ...
	  function Register() {
	    ...
	    _this.state = store.getState();
	    _this.changeUsername = function (ev) {
	      return store.dispatch({
	        type: 'UPDATE_FIELD',
	        key: 'username',
	        value: ev.target.value
	    ...
	    _this.submitForm = function (ev) {
	      ...
	      store.dispatch({
	        type: 'REGISTER',
	        payload: agent.Auth.register(_this.state.username, _this.state.email, _this.state.password)
	      });
	    };
	    return _this;
	  }
