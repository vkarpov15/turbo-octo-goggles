...
/***/ function(module, exports, __webpack_require__) {
	...
	var Redux = __webpack_require__(216);
	var agent = __webpack_require__(227);
	var history = __webpack_require__(235);
	var middleware = __webpack_require__(239);
	var reducer = __webpack_require__(240);
	...
	var ListErrors = function ListErrors(errors) {
	  if (errors) {
	    return React.createElement(
	      'ul',
	...
	var Login = function (_React$Component3) {
	  ...
	  function Login() {
	    ...
	    _this4.state = store.getState();
	    _this4.changeEmail = function (ev) {
	    ...
	    _this4.changePassword = function (ev) {
	      return store.dispatch({
	        type: 'UPDATE_FIELD',
	        key: 'password',
	        value: ev.target.value
	    ...
	    _this4.submitForm = function (ev) {
	      ev.preventDefault();
	      store.dispatch({
	        type: 'LOGIN',
	        payload: agent.Auth.login(_this4.state.email, _this4.state.password)
	      });
	    };
	    return _this4;
	  }
	  ...
	  _createClass(Login, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      this.unsubscribe = store.subscribe(function () {
	        _this5.setState(store.getState());
	      });
	    }
	  }, {
	    key: 'componentWillUnmount',
	    ...
	    value: function componentDidMount() {
	      ...
	      store.subscribe(function () {
	        ...
	        if (store.getState().redirectTo) {
	          _this7.context.router.replace(store.getState().redirectTo);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var superagent = __webpack_require__(228)(__webpack_require__(229), global.Promise);
